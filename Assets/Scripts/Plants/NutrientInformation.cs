...
public class NutrientInformation : ScriptableObject
{
    ...
    public bool ChangeColour, ChangeSaturation, LoseGrowthStage, LeafHoles, InstantDeath, RestrictNutrientIntake;
    [Header("Effects of Nutrient Overabundance")]
    public bool ChangeColourHigh, ChangeSaturationHigh, LoseGrowthStageHigh, LeafHolesHigh, InstantDeathHigh, RestrictNutrientIntakeHigh;
